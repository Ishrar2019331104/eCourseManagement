...
<div class="row justify-content-center pt-4" style="height: 80vh;">
                <div class="col-md-6 text-center">
                    <h3 class="display-4">Enrolled Courses</h3>
                    <br>
...
<tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="enrolledStudent.jsp?courseCode=<%= rs.getString("courseCode") %>" class="btn btn-primary btn-sm">View Students</a></td>
                            </tr>
                            <% }%>
                        </tbody>
  </table>
  <a href="teacherHome.jsp" class="btn btn-default">Return to Home</a>
  </div>
    <!--javascript-->
